...
function Profile() {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        if (!userData) {
          console.error("No user object in profile response", response.data);
          return;
        }
        ...
        setFollowing(
          Array.isArray(userData.followings) ? userData.followings.length : 0
        );
      })
      .catch((error) => {
  ...
  //   axios
  //     .get(`http://localhost:3001/api/followers/${userId}/followers`)
  //     .then((response) => {
  //       console.log("Followers fetched:", response.data);
  //       setFollowers(response.data.followers);
  //     });

  //   axios
  //     .get(`http://localhost:3001/api/profile/${userId}/following`)
  //     .then((response) => {
                  ...
                  <div>
                    <Space direction="vertical">
                      <Switch
                        ...
                        defaultChecked={privateAccount} onChange={(checked) => {
