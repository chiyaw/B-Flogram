...
function Register() {
    return (
        <div className="flex flex-col  h-screen w-screen items-center justify-center bg-[url(./assets/register.jpeg)] bg-cover bg-center bg-no-repeat">
            ...
            <div className='h-150 w-100 gap-6 flex flex-col items-center rounded-xl backdrop-blur-md bg-orange-100/50 divide-y-3 divide-solid divide-black'>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="Enter UserID" className="mx-3 mb-3 p-3 rounded-xl bg-orange-100/50 w-80" />
                    </div>

                    <div>
                        <div className="mx-3 ">Password</div>
                        <input type="text" placeholder="Enter Password" className="mx-3 mb-3 p-3 rounded-xl bg-orange-100/50 w-80" />
                    </div>
