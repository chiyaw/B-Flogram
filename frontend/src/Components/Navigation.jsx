        ...
        <div className="flex flex-row top-18 bottom-0 left-0 md:shadow-2xl items-top bg-orange-100/50 fixed z-10 transition-all duration-300">
            <div className='text-gray-800 md:w-40 mt-2 gap-2 pt-2'>
                {sections.map((section, index) => (
                    <div className="flex flex-row items-center gap-2 shadow-md m-2 p-2 rounded-r-lg border-l-4 border-orange-400 bg-orange-200/50 hover:border-gray-500 cursor-pointer transition-all duration-200" key={index} onClick={() => navigate(section.url)} >
